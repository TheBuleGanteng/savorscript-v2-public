document.addEventListener('DOMContentLoaded', function() {
    ...
    window.enableProfileSubmitButton = enableProfileSubmitButton;
    ...
    if (window.location.href.includes('/profile')) {
        ...
        console.log("You are not running savorscript.js for /profile");
    }
    ...
    function jsProfileUsernameValidation() {
        return new Promise((resolve, reject) => {
            var username_input = document.getElementById('username_input').value.trim();
            var username_validation = document.getElementById('username_validation');
            console.log(`Running jsProfileUsernameValidation()`)
            console.log(`Running jsProfileUsernameValidation()... username_input is: ${username_input}`)
            ...
            if (username_input === '') {
                console.log(`Running jsUsernameValidation()... username_input ==='' (username_input is empty)`)
            ...
            // If username != empty, do the following...
                ...
                console.log(`Running jsUsernameValidation()... username_input != '' (username_input is not not empty)`)
                fetch('/check_username_availability', {
                    method: 'POST',
                    body: new URLSearchParams({ 'username': username_input }),
                    headers: {
    ...
    async function enableProfileSubmitButton() {
        ...
        console.log(`Running enableSubmitButton()... value for username_validation is: ${ username_validation}`)
        ...
        if (
            (name_first_input !== '' || name_last_input !== '' || username_input !== '' || birthdate_input !== '' || gender_input !== '') &&
    ...
    if (window.location.href.includes('/register')) {
        ...
        console.log("You are not running savorscript.js for /register");
    }
